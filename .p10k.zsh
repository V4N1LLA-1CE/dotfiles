# Generated by Powerlevel10k configuration wizard on 2024-06-13 at 05:23 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=0 # Default current directory foreground color. Default is usually 4, use 0 for coolnight theme 
